...
pub enum COPT_A {
    #[doc = "0: COP disabled"]
    _00 = 0,
    #[doc = "1: COP timeout after 25 LPO cycles or 213 bus clock cycles"]
    _01 = 1,
    #[doc = "2: COP timeout after 28 LPO cycles or 216 bus clock cycles"]
    _10 = 2,
    #[doc = "3: COP timeout after 210 LPO cycles or 218 bus clock cycles"]
    _11 = 3,
}
...
impl<'a> COPT_W<'a> {
    ...
    #[doc = "COP timeout after 25 LPO cycles or 213 bus clock cycles"]
    #[inline(always)]
    pub fn _01(self) -> &'a mut W {
        self.variant(COPT_A::_01)
    }
    #[doc = "COP timeout after 28 LPO cycles or 216 bus clock cycles"]
    #[inline(always)]
    pub fn _10(self) -> &'a mut W {
        self.variant(COPT_A::_10)
    }
    #[doc = "COP timeout after 210 LPO cycles or 218 bus clock cycles"]
    #[inline(always)]
