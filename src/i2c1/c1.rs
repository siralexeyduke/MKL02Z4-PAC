...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TXAK_A {
    #[doc = "0: An acknowledge signal is sent to the bus on the following receiving byte"]
    _0 = 0,
    #[doc = "1: No acknowledge signal is sent to the bus on the following receiving data byte."]
    _1 = 1,
}
...
impl<'a> TXAK_W<'a> {
    ...
    #[doc = "An acknowledge signal is sent to the bus on the following receiving byte"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(TXAK_A::_0)
    }
    #[doc = "No acknowledge signal is sent to the bus on the following receiving data byte."]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
